...
export default function AddressesCreateButton({ locale, countries }: Props) {
  ...
  return (
    <>
      ...
      <CreateAddressModal locale={locale} countries={countries} open={open} onClose={() => setOpen(false)} />
    </>
  );
}
